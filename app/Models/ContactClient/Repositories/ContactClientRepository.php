...
final class ContactClientRepository implements ContactClientInterface
{
  ...
  //     'samy.CONTACTO_CLIENTE.CLIENTE',
  //     'C.NOMBRE'
  //   )
  //     ->distinct()
  //     ->join('samy.CLIENTE as C', 'samy.CONTACTO_CLIENTE.CLIENTE', '=', 'C.CLIENTE')
  //     ->where('samy.CONTACTO_CLIENTE.CELULAR', $mobile)
  //     ->groupBy('samy.CONTACTO_CLIENTE.CLIENTE', 'samy.CONTACTO_CLIENTE.CELULAR', 'C.NOMBRE')
  //     ->get()
  //     ->toArray();
  //   // $response = [];
  ...
  {
    $clients = $this->model::select(
      'SAMY_GBI.dbo.gbi_contactoscliente_cstm.documento_cliente_c AS CLIENTE',
